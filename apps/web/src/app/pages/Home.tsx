  ...
  return (
    <div className="w-full">
      ...
      <section id="services" className="py-24 bg-stone-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-stone-900 mb-6">{siteContent.services.heading}</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              <div key={index} className="bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition-shadow duration-300 border border-stone-100 group cursor-pointer flex flex-col">
          ...
          <div className="mt-12 text-center">
            <div className="inline-flex items-center gap-4 bg-white px-6 py-4 rounded-xl shadow-sm border border-stone-100 text-stone-700">
              <span className="text-green-800 font-semibold">{siteContent.services.additionalServicesLabel}</span>
              <span>{siteContent.services.additionalServices}</span>
              <span className="w-1 h-1 rounded-full bg-stone-300"></span>
              <a href="#contact" className="text-green-800 hover:underline font-semibold">{siteContent.services.additionalServicesLink}</a>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
            <div>
              <h2 className="text-3xl md:text-4xl font-bold text-stone-900 mb-6">{siteContent.whyChoose.heading}</h2>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                {siteContent.whyChoose.points.map((point, index) => (
                  <div key={index} className="flex items-start gap-4 p-4 rounded-xl bg-stone-50 border border-stone-100 hover:border-green-200 transition-colors">
            ...
            <div className="bg-stone-900 rounded-3xl overflow-hidden relative shadow-2xl">
              ...
              <div className="relative z-10 p-10 md:p-14 h-full flex flex-col justify-end min-h-[500px] bg-gradient-to-t from-stone-900 via-stone-900/40 to-transparent">
                ...
                <h3 className="text-3xl font-bold text-white mb-4">{siteContent.whyChoose.featuredProject.title}</h3>
            ...
            <div className="relative z-10">
              ...
              <div className="flex flex-wrap justify-center gap-3">
                {siteContent.areas.locations.map((area, idx) => (
                  <span key={idx} className="px-5 py-2.5 bg-white border border-stone-200 shadow-sm rounded-full text-stone-700 font-medium text-sm">
                    {area}
                  </span>
                ))}
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-stone-900 mb-6">{siteContent.testimonials.heading}</h2>
            <p className="text-lg text-stone-600">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {siteContent.testimonials.reviews.map((testimonial, idx) => (
              <div key={idx} className="bg-stone-50 p-8 rounded-2xl relative">
                <svg className="w-10 h-10 text-stone-200 absolute top-6 right-6" fill="currentColor" viewBox="0 0 24 24">
